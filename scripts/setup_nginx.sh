...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/mytonstorage.org/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/mytonstorage.org/privkey.pem; # managed by Certbot
