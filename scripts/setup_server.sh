...
check_required_vars() {
    ...
    if [[ ${#missing_vars[@]} -gt 0 ]]; then
        ...
        echo "DOMAIN=mytonstorage.org INSTALL_SSL=true \\"
...
main() {
    ...
    print_status "Step 8: Installing ton storage..."
    ...
    # todo: review copypaste from mytonstorageorg
    # todo: add ton storage api instructions
    ...
    # echo "Start service: cd /opt/storage && env \$(cat config.env | xargs) ./mtpo-backend >> /var/log/mytonstorage.app/mytonstorage.app.log 2>&1 &"
    # echo "View logs: tail -f /var/log/mytonstorage.app/mytonstorage.app.log"
    # echo ""
